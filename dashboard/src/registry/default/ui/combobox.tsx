...
// Upstream coss combobox (registry/default/ui/combobox.tsx). The only local
// tweak: ScrollArea here has no `overscrollContain` prop — its viewport
// already applies overscroll containment when overflowing.
