...
export function clientHelp(): string {
  return [
    ...
    "",
    "Channels: room publish/subscribe is for test/control messages; logs/grep read the owning process stdout/stderr. Do not publish all console output to a room.",
    "",
